...
import { LogOut, Mail, MessageSquare, Star, FileText, Package, Loader, Settings, Info, Video, Users, Phone } from 'lucide-react';
...
export default function Dashboard({ onLogout }: DashboardProps) {
  ...
  const fetchStats = async () => {
    try {
      const [contacts, testimonials, services, products] = await Promise.all([
